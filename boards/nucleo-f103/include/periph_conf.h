...
#define UART_2_RX_PIN       GPIO(PORT_B, 11)
#define UART_2_TX_PIN       GPIO(PORT_B, 10)
/** @} */
...
#define SPI_0_SCK_PIN           GPIO(PORT_A, 5)
...
#define I2C_0_SCL_PIN       GPIO(PORT_B, 8) /* remapped */
#define I2C_0_SDA_PIN       GPIO(PORT_B, 9) /* remapped */
